...
tar -jxf /root/hdf5-1.10.4.tar.bz2 && cd /root/hdf5-1.10.3 && ./configure --disable-static --enable-shared --disable-fortran --enable-hl --prefix=/usr --with-szlib && make -j 4 && sudo make install
