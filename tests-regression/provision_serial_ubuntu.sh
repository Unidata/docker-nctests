...
tar -jxf /root/hdf5-1.10.5.tar.bz2 && cd /root/hdf5-1.10.5 && ./configure --disable-static --enable-shared --disable-fortran --enable-hl --prefix=/usr --with-szlib && make -j 4 && sudo make install
