...
if [ "x$DO32" == "xTRUE" ]; then
    ...
    xterm -T serial32 -bg black -fg white -geometry 140x20 -e tail -f serial32.log&
    sleep 1

    echo "Starting OpenMPI32 Image"
    docker build -t $IPREF:openmpi32 -f Dockerfile.openmpi32 . &> openmpi32.log&
    xterm -T openmpi32 -bg black -fg white -geometry 140x20 -e tail -f openmpi32.log&
    sleep 1

    echo "Starting MPICH32 Image"
    docker build -t $IPREF:mpich32 -f Dockerfile.mpich32 . &> mpich32.log&
    xterm -T mpich32 -bg black -fg white -geometry 140x20 -e tail -f mpich32.log&
    sleep 1
fi
...
if [ "x$DO64" == "xTRUE" ]; then
    ...
    xterm -T serial -bg black -fg white -geometry 140x20 -e tail -f serial.log&
    sleep 1

    echo "Starting OpenMPI Image"
    docker build -t $IPREF:openmpi -f Dockerfile.openmpi . &> openmpi.log&
    xterm -T openmpi -bg black -fg white -geometry 140x20 -e tail -f openmpi.log&
    sleep 1

    echo "Starting MPICH Image"
    docker build -t $IPREF:mpich -f Dockerfile.mpich . &> mpich.log&
    xterm -T mpich -bg black -fg white -geometry 140x20 -e tail -f mpich.log&
    sleep 1
